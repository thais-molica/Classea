		...
		<div class="container">
			...
			<main class="main special-category">
				...
				<section class="gallery photo">
					...
					<span class="description">A Classe A, oferece um ensinamento exclusivo para criancas. Veja nossa galeria de foto e confira um pouco do
					nosso trabalho</span>
				</section>
				<section>
					<h2>Qualidade KIDS Classe A</h2>
					<p>
