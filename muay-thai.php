...
<html lang="pt-br">
	<head>
		...
		<title>Muay-thai - Classe A</title>
	</head>
	<body>
		<div class="container">
			...
			<main class="main modalities muay-thai">
				...
				<section class="banner-menu">
					<div class="content">
						...
						<div class="info">
						<h1>Muay-thai</h1>
						<button class="activate-modal" data-target="muay-thai">Grade de aulas</button>
						<div class="box">
							<div class="column">
							...
							<div class="column">
								<h2>CALORIAS GASTA COM Muay-Thai</h2>
