...
<html lang="pt-br">
	<head>
		...
		<title>Taekwon-do - Classe A</title>
	</head>
	<body>
		<div class="container">
			...
			<main class="main modalities taekwon-do">
				...
				<section class="banner-menu">
					<div class="content">
						...
						<div class="info">
						<h1>Taekwon-do</h1>
						<button class="activate-modal" data-target="taekwon-do">Grade de aulas</button>
						<div class="box">
							<div class="column">
							...
							<div class="column">
								<h2>CALORIAS GASTA COM Taekwon-do</h2>
